...
* **starting\_ordinal**: This is a non-negative whole number that represents the first delivery "position" for the product in the planned sequence. See the *Additional Considerations* section below for more details on how `starting_ordinal` works.
