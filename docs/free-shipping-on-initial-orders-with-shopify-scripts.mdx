...
Note that free shipping set up in Ordergroove only applies to recurring subscription orders, and not the initial order when a customer purchases a subscription. [See this article for more information about subscription shipping and delivery for Shopify](https://help.ordergroove.com/hc/en-us/articles/4406641707923-Shopify-Shipping-and-Delivery#h_01GSBNF4X0QT5RQ97JG98T5PVB).
...
7. Edit file: `ordergroove-discount/src/cart_delivery_options_discounts_generate_run.graphql` Replace full file with below code:
...
8. Edit file: `ordergroove-discount/src/cart_delivery_options_discounts_generate_run.js` Replace full file with below code:
...
For further customizations to the above script, you can reference [Shopify's excellent documentation on the Shopify Help Center](https://shopify.dev/docs/api/functions/latest). You'll find [great examples of building Functions](https://shopify.dev/docs/apps/build/discounts/build-discount-function) that you can adapt and use with your subscription program.

***

[First Order Place Date control for Shopify Merchants](/docs/first-order-place-date-control-for-shopify-merchants)

[Subscription Manager](/docs/subscription-manager)
