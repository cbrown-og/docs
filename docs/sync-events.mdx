...
To start using events, visit our [Webhooks documentation](https://developer.ordergroove.com/reference/webhooks-overview) for setup instructions and a full list of supported event types.

***

[SFTP File Drops](/docs/sftp-file-drops)

[Webhooks & APIs](/docs/webhooks-apis)
