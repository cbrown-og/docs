...
2. [Prepaid Subscriptions](/docs/prepaid-subscriptions-1)
...
All subscriptions will be created using the default renewal behavior, which is `autorenew`. The default renewal behavior can be changed if you want your customers to have their prepaid subscriptions canceled or downgraded to normal subscriptions at the end of their cycles. In case you want to change the default renewal behavior of your store please contact us at [\[email protected\]](/cdn-cgi/l/email-protection#e2919792928d9096a28d9086879085908d8d9487cc818d8f).
