...
[Developer Sandbox Store](https://player.vimeo.com/video/1167508370?h=d379030d28\&badge=0\&autopause=0\&player_id=0\&app_id=58479)
...
1. Open up the [Shopify dev dashboard](https://dev.shopify.com)
...
![](/images/docs/c7ea8e56877846233efa007c471f78eb4c6fb4b546de9e036cca62349b90d7b7-Shopify_Test_Products.png)
...
![](/images/docs/19d7e10f6d4375d9ad1499e4ec58461f93965e3d33aa26e673722a2179980793-Shopify_Theme.png)
...
2. Locate *Ordergroove*, and click ***Install***.
   ...
   ![](/images/docs/28bf2b432bff29dace09be251cb27965b15d0d70cb56b5189d23e57e6379aabd-Ordergroove_App_Listing.png)
...
10. On the App Embed page, click ***Configure***. It'll open a new tab redirecting you back to your Shopify Store. Make sure Ordergroove Offers Embed is checked on. Then hit ***Save*** and close the tab.
    ...
    ![](/images/docs/8483434caced6c9b513fee003d4431fac6bbae393d352bca738984a952daef7a-Offers_Embed.png)
...
11. Back in Ordergroove, click Next to go to the Customize page. Click ***Customize***. This will take you back to Shopify. Under *Template > Product Information*, click and drag ***Ordergroove Offer*** beneath ***Price***. Click ***Save*** and close the tab.
    ...
    ![](/images/docs/0a72a27c4130343ae4049103a1fc08d03501875ffcdd105ff78bfe8199f5a9b5-Ordergroove_Offer_Page.png)
...
4. Once you submit the form, refresh the page and make sure Test Mode is on. You should see:
   ...
   ![](/images/docs/82536d1b2fa18597abfb70a02f111b361dcda06d73e18ebfb37b6d0b4b4b145e-Shopify_Test_Mode.png)
...
2. Click on the ***Account*** icon on the top right. This will create a customer, enter an email you have access to. Shopify will send you a verification code, we'll need it in the next step.
   ...
   ![](/images/docs/064a77aeecbc1fc2e0299e46798f67157f14d62bf7e88c6c545bd9d3593d9bcb-Account_Icon.png)
...
<Warning>
  ...
  1. Open up [Ordergroove](https://rc3.ordergroove.com/) and go to Data > Products
...
1. Open up [Ordergroove](https://rc3.ordergroove.com/), and go to ***Data > Customers***.
...
5. Ordergroove will display the Order Details, and you'll see a few options including Send Now. Click Send Now to send the order to Shopify for placement.
   ...
   ![](/images/docs/f75ff8c79d8c59c8e7c0c88fd13ca1159f7168d7aae6d8e026b532a665407069-send_now_screenshot.png)

6. Ordergroove will send the order for placement, and queue up the next Order:

   ![](/images/docs/094fcaafca025b6d9eb9c28388dce163f8700fe5734452b071a9743943463a4e-Order_Successful.png)
...
4. Click on the ***subscription product*** and scroll down. You can find the subscription contract in the ***Purchase Options*** section.
   ...
   ![](/images/docs/134e2c9503c80fce51cf5e0eb787d7d47574913336cec9ea03d3dc21fec920b1-Purchase_Options.png)
