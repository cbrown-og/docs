...
![](/images/docs/acd7623-image1.png)
...
![](/images/docs/7a58b1b-cat_food_CLEAN.png)
...
For example, let's imagine that we have the parent product of id 1 and 4 products with ids from 2 to 5. In the case where we want 2 different bundles with products 3 and 5 in it respectively and both using the same parent product, the following needs to be configured:

* 3: `__og_parent_product_id = '1:bundle_1'`
* 5: `__og_parent_product_id = '1:bundle_2'`
...
| ------------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ---------------------------------------------------------------------- |
| Banana       | 10       | `name="properties[__og_subscription_bundle_item_quantity]" value="5"``name="properties[__og_parent_product_id]" value="{bundle_product_id}"`  | 10                                  | 5                                                                      |
| Orange Juice | 2        | `name="properties[__og_parent_product_id]" value="{bundle_product_id}"`                                                                       | 2                                   | 2                                                                      |
| Apple        | 5        | `name="properties[__og_subscription_bundle_item_quantity]" value="10"``name="properties[__og_parent_product_id]" value="{bundle_product_id}"` | 5                                   | 10                                                                     |
...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------- |
| Banana        | `name="properties[__og_subscription_bundle_item_product_swap]" value="{orange_juice_id}"``name="properties[__og_parent_product_id]" value="{bundle_product_id}"` | Banana               | Orange Juice              |
...
| Checkout Item | Properties in the item                                                                                                                                                                                                                     | Checkout Order Items | Future Subscription Items         |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- | --------------------------------- |
| Banana        | `name="properties[__og_subscription_bundle_item_additions]" value='[{"product":"{orange_juice_id}","quantity":1},{"product":"{exquisite_apple_id}","quantity":2}]'``name="properties[__og_parent_product_id]" value="{bundle_product_id}"` | Banana               | BananaOrange JuiceExquisite Apple |
...
| --------------------------------------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | -------------------------------------------------- |
| **Quantity Override and Product Swap**                    | Banana        | `name="properties[__og_subscription_bundle_item_quantity]" value="5"``name="properties[__og_subscription_bundle_item_product_swap]" value="{orange_juice_id}"``name="properties[__og_parent_product_id]" value="{bundle_product_id}"`                                                                                                                                                                          | Banana - 1                      | Orange Juice - 5                                   |
| **Product Swap and Additional Items**                     | Banana        | `name="properties[__og_subscription_bundle_item_product_swap]" value="{orange_juice_id}"``name="properties[__og_subscription_bundle_item_additions]" value='[{"product": "{grape_juice_id}", "quantity": 1}, {"product": "{exquisite_apple_id}", "quantity": 2}]'``name="properties[__og_parent_product_id]" value="{bundle_product_id}"`                                                                      | Banana - 1                      | Orange Juice - 1Grape Juice - 1Exquisite Apple - 2 |
| **Quantity Override, Product Swap, and Additional Items** | Banana        | `name="properties[__og_subscription_bundle_item_quantity]" value="5"``name="properties[__og_subscription_bundle_item_product_swap]" value="{grape_juice_id}"``name="properties[__og_subscription_bundle_item_additions]" value='[{"product": "{orange_juice_id}", "quantity": 1}, {"product": "{exquisite_apple_id}", "quantity": 2}]'``name="properties[__og_parent_product_id]" value="{bundle_product_id}"` | Banana - 1                      | Grape Juice - 5Orange Juice - 1Exquisite Apple - 2 |
