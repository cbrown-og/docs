...
(2026-03-31) Support displaying special page when customer has no digital plans yet.

## v25.15.3

(2026-03-25) Do not apply one-time styles to gift items.

## v25.15.2

(2026-03-23) Support displaying free gift items for an order.

## v25.15.1

(2026-03-19) Change default header copy to "Your Subscriptions".

## v25.15.0

(2026-03-16) Display grantees for digital subscriptions.

## v25.14.9

(2026-03-12) Update date filter usage to improve internationalization.

## v25.14.8

(2026-03-04) Update internal dependency.
...
(2026-03-03) Update digital subscription benefits display when there are multiple subscriptions for the same product.

## v25.14.5

(2026-02-10) Update internal dependency.

## v25.14.4

(2026-02-10) Fix issue when previewing cancelled digital subscriptions in RC3.

## v25.14.3

(2026-01-30) Update internal dependency.

## v25.14.2

(2026-01-16) Update digital subscription item price display.

## v25.14.1

(2026-01-12) Update internal dependency.

## v25.14.0

(2026-01-07) Introduces the ability for customers to manage their digital subscriptions.

## v25.13.0

(2025-12-10) Enable retention discounts in the cancel flow by default for new templates.

## v25.12.0

(2025-12-09) Enable "pause subscription" save tactic in the cancel flow by default for new templates.

## v25.11.4

(2025-11-07) Fix a bug where processing orders incorrectly showed "Send Now" and "Skip Order" buttons.
...
(2025-03-04) Fix bug in datepicker for HTML lang values that include a locale as well as a language.
...
(2025-01-03) Add `data-max-date-offset-days` attribute to `sm-datepicker` custom element.
...
(2024-11-05) Pre-alpha support for opt-in tracking of Subscription Manager interactions. Reach out to Ordergroove for more information.
...
For more information, check out our [Tour of Subscription Manager v25](https://developer.ordergroove.com/docs/tour-of-subscription-manager-v25)
...
(2023-03-13) Allow changing the product for prepaid subscriptions.

## v0.33.1

(2022-12-06) Add a payment update flow for Shopify merchants.

## v0.33.0

(2022-12-05) Support displaying orders that contain prepaid and non-prepaid subscriptions.

## v0.32.0

(2022-11-09) Continued improvements to prepaid offers.

## v0.31.0

(2022-09-08) Enhance the display of prepaid orders.

## v0.30.0

(2022-08-15) Add a cancel flow that gives customers the opportunity to skip their next order instead of ending their subscription.

## v0.29.3

(2022-01-24) Fix an issue with missing styles.

***

[Enabling Payment Updates for Shopify New Accounts](/docs/enabling-payment-updates-for-shopify-new-accounts)

[Legacy Subscription Manager v0 Components & Containers](/docs/subscription-manager-components-containers)
