...
To set a maximum amount of days a customer can select, simply add an attribute to `sm-datepicker` with the number of days as the value. For example, to limit selection to the next 30 days, update your `sm-datepicker` in `reactivate-subscription.liquid` to look like this: `<sm-datepicker data-max-date-offset-days="30">`
...
![](/images/docs/75fdb81-Screen_Shot_2023-06-26_at_16.45.04.png)
...
![](/images/docs/d6376ff-Screen_Shot_2023-06-26_at_17.12.31.png)
