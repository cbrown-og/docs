---
title: "Using Webhooks for 1-Click Actions"
---
...
<Warning>
  ...
  * Standard Implementation: If you use Ordergroove’s `main.js` or `oca.js`, follow the URL structures in our [Knowledge Center](https://help.ordergroove.com/hc/en-us/articles/13554075021971-Add-1-Click-Actions-to-Klaviyo-Flows#01H7X9Y1GVJHXBHA13TD15KRKN).
...
Note: Reactivate with Discount and Winback Incentives are currently in Alpha, please reach out to [support](https://help.ordergroove.com/hc/en-us/requests/new) to have both enabled for your store. Once Winback Incentives are enabled, create a new one with [these instructions](https://help.ordergroove.com/hc/en-us/articles/13554075021971-Add-1-Click-Actions-to-Klaviyo-Flows#h_01KG0141VXSK79Y5BG50EGZP91).
