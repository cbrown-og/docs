---
title: "Instant Upsell through API"
---
...
![](/images/docs/72c2d12-image1.jpg)
...
This method allows you to create additional subscriptions using a single API call, but requires an existing address and payment ID to be provided in the POST request. Make a POST to [https://restapi.ordergroove.com/subscriptions/iu/](https://restapi.ordergroove.com/subscriptions/iu/)
