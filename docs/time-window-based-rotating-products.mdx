---
title: "Time Window Based Rotating Products"
---

1. Advanced Subscription Types
2. [Rotating Subscriptions](/docs/rotating-subscriptions)
...
There are no explicitly defined ending dates for any single **selection rule**– ending dates are relatively defined by other selection rules in the rotation. The nearest upcoming starting date of another product determines the end date of the current one.

![](/images/docs/a3c609a-Screenshot_2024-05-22_at_11.44.27_AM.png)
...
[Prepaid Subscriptions](/docs/prepaid-subscriptions-1)
