...
Staging: [https://staging.sc.ordergroove.com/subscription/create](https://staging.sc.ordergroove.com/subscription/create) Production: [https://sc.ordergroove.com/subscription/create](https://sc.ordergroove.com/subscription/create)

API Keys

Staging: [https://rc3.stg.ordergroove.com/keys/](https://rc3.stg.ordergroove.com/keys/) Production: [https://rc3.ordergroove.com/keys/](https://rc3.ordergroove.com/keys/)
